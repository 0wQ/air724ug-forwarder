...
-- 设备功能介绍:
-- 本固件支持外接扬声器和麦克风, 可以实现接打电话等功能, 推荐连接后使用

-- 连接扬声器后, 可以通过短按/长按 POWERKEY 来切换选择菜单项
-- 菜单项包含: 扬声器音量/扬声器静音/通话音量/麦克音量/回拨电话/测试通知/网卡/短信播报/来电动作/开机通知/查询流量/查询温度/查询时间/查询信号/查询内存/查询电压/重启/关机
...
-- 短信格式示例: CALL,10086 或 SMS,10086,查询流量
